...
- [x] Updated download_images.py to use public medical datasets (ISIC, DermNet) instead of illegal scraping.
- [x] Updated train_models.py to handle missing data gracefully with synthetic data generation.
- [x] Created basic analysis function in src/spin_analysis.py.
